...
Used today by the quickstart wizard to pre-flight Ollama before
creating a listener — surfacing "Ollama unreachable" at config time
beats discovering it via 500-per-judge-cycle once polling starts.
"""
