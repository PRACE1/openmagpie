"""Prompts + content sizing for the Ollama judgment call.

Lifted out of engine.py so a copy-edit on the scorer prompt doesn't
churn the engine class's git history (and so prompt iteration shows up
